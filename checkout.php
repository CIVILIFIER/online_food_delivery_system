        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.html"> <img class="img-rounded" src="images/PES.jpg" alt=""> </a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="payment-option">
                                        ...
                                        <input type="submit" onclick="return confirm('Are you sure?');" name="submit" class="btn btn-outline-success btn-block" value="Order now / Proceed to Payment">
                                    </div>
									</form>
                                    <form action="onlinepayments.php" method="post">
        <!-- Your checkout form --><label>ONLINE:-</label>
                        </br>
                ...
                <div class="container">
                    ...
                    <div class="row top-footer">
                        <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                            <a href="#"> <img src="images/PES.jpg" alt="Footer logo"> </a> <span>Order Delivery &amp; Take-Out </span> </div>
